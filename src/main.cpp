...
#if defined(NDEBUG)
# error "FlexCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "FlexCoin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// FlexCoin: attempt to generate suitable proof-of-stake
